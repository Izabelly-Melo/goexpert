...
func (c *CategoryService) ListCategories(ctx context.Context, in *pb.Blank) (*pb.CategoriesList, error) {
	...
	return &pb.CategoriesList{Categories: categoriesResponse}, nil
}
