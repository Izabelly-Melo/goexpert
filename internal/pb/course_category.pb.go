...
const file_proto_course_category_proto_rawDesc = "" +
	...
	"\x0eCreateCategory\x12\x19.pb.CreateCategoryRequest\x1a\f.pb.Category\"\x00\x12I\n" +
	"\x14CreateCategoryStream\x12\x19.pb.CreateCategoryRequest\x1a\x12.pb.CategoriesList\"\x00(\x01\x12R\n" +
	"!CreateCategoryStreamBidirectional\x12\x19.pb.CreateCategoryRequest\x1a\f.pb.Category\"\x00(\x010\x01\x121\n" +
	"\x0eListCategories\x12\t.pb.Blank\x1a\x12.pb.CategoriesList\"\x00\x125\n" +
...
var file_proto_course_category_proto_depIdxs = []int32{
	...
	3, // 7: pb.CategoryService.CreateCategoryStream:output_type -> pb.CategoriesList
	0, // 8: pb.CategoryService.CreateCategoryStreamBidirectional:output_type -> pb.Category
	3, // 9: pb.CategoryService.ListCategories:output_type -> pb.CategoriesList
